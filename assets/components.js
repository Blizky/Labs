  ...
  connectedCallback() {
    ...
    const MENU_APPS = [
      ...
      },
      {
        name: "Cooklog",
        href: "/Cooklog/",
        icon: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true"><rect width="32" height="32" rx="5" ry="5" fill="#0099CC"/><g fill="#fc3"><path d="M10 4a1 1 0 0 1 1 1v7a4 4 0 0 1-3 3.873V25a1 1 0 1 1-2 0v-9.127A4 4 0 0 1 3 12V5a1 1 0 1 1 2 0v6h1V5a1 1 0 0 1 2 0v6h1V5a1 1 0 0 1 1-1M20 4a5 5 0 0 1 5 5v16a1 1 0 1 1-2 0v-7h-3v7a1 1 0 1 1-2 0V9a5 5 0 0 1 2-5m0 2a3 3 0 0 0-3 3v7h6V9a3 3 0 0 0-3-3"/></g></svg>`
      },
      {
        name: "Corrector",
        href: "/corrector/",
      ...
      {
        name: "Threadmaker",
        href: "/threadmaker/index.html",
        icon: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true"><rect width="32" height="32" rx="5" ry="5" fill="#0099CC"/><g transform="translate(6 7)"><path fill="#fc3" d="M1 0h18a1 1 0 0 1 0 2H1A1 1 0 0 1 1 0m0 8h18a1 1 0 0 1 0 2H1a1 1 0 0 1 0-2m0 8h11a1 1 0 0 1 0 2H1a1 1 0 0 1 0-2"/></g></svg>`
      },
      {
        name: "Octofind",
        href: "/octofind/",
